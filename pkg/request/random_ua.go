...
// RandomUA generates a random DESKTOP browser user-agent on every requests
func RandomUA() string {
	return uaGens[rand.Intn(len(uaGens))]()
}

// RandomMUA generates a random MOBILE browser user-agent on every requests
func RandomMUA() string {
